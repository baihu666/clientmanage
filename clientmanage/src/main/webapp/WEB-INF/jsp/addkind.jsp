	...
	<div class="body">
		<div class="row" style="margin: 0;">
			<div class="pull-right" style="width: 80%;margin-top:100px">
				<form id="form1" action="kind/savekind.action" method="Post"
					style="position: relative;">
					产品类别名称：<input type="text" name="name">
					<button class="btn btn-primary btn-sm" type="submit" style="width: 60px; height: 30px">添加</button>
				</form>
			</div>
		</div>
	</div>
